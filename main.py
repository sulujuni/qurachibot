...
async def post_init(application: Application) -> None:
    ...
    command_sets = {
        ...
        None: [
            ...
            BotCommand("grouppick", "Pick specific winner from group giveaway"),
            BotCommand("groupentries", "View group giveaway entries"),
            BotCommand("pickrandom", "Pick random commenter from a post"),
            BotCommand("trackpost", "Track a post for comment randomizer"),
            BotCommand("mygiveaways", "Your giveaways (paginated)"),
            BotCommand("mychannels", "Your channels (manage)"),
            BotCommand("edit", "Edit a giveaway"),
            BotCommand("notify", "Notify giveaway participants"),
            BotCommand("cancelgiveaway", "Cancel a giveaway"),
            BotCommand("cancelgroupgiveaway", "Cancel a group giveaway"),
            BotCommand("mycontests", "Your contests"),
            BotCommand("startvoting", "Start voting phase in a contest"),
            BotCommand("endcontest", "End contest & announce winners"),
            BotCommand("cancelcontest", "Cancel a contest"),
            BotCommand("referral", "Your invite link & stats"),
            BotCommand("points", "View your loyalty points"),
            BotCommand("leaderboard", "Top users"),
            BotCommand("subscribe", "Subscribe to new game alerts"),
            BotCommand("unsubscribe", "Unsubscribe from alerts"),
            BotCommand("settings", "Settings & preferences"),
        ...
        "ru": [
            ...
            BotCommand("grouppick", "Выбрать конкретного победителя"),
            BotCommand("groupentries", "Посмотреть заявки"),
            BotCommand("pickrandom", "Случайный комментатор из поста"),
            BotCommand("trackpost", "Отслеживать пост для рандомайзера"),
            BotCommand("mygiveaways", "Мои розыгрыши"),
            BotCommand("mychannels", "Мои каналы (управление)"),
            BotCommand("edit", "Редактировать розыгрыш"),
            BotCommand("notify", "Уведомить участников"),
            BotCommand("cancelgiveaway", "Отменить розыгрыш"),
            BotCommand("cancelgroupgiveaway", "Отменить групповой розыгрыш"),
            BotCommand("mycontests", "Мои конкурсы"),
            BotCommand("startvoting", "Начать голосование в конкурсе"),
            BotCommand("endcontest", "Завершить конкурс и объявить победителей"),
            BotCommand("cancelcontest", "Отменить конкурс"),
            ...
            BotCommand("dashboard", "Открыть Mini App"),
            BotCommand("lang", "Сменить язык"),
        ],
        "uz": [
            BotCommand("start", "Botni ishga tushirish"),
            BotCommand("help", "Barcha buyruqlar ro'yxati"),
            BotCommand("newgiveaway", "Yutuqli o'yin yaratish"),
            ...
            BotCommand("draw", "G'oliblarni aniqlash"),
            BotCommand("groupdraw", "Guruh g'oliblarini aniqlash"),
            BotCommand("grouppick", "Aniq g'olibni tanlash"),
            BotCommand("groupentries", "Ishtiroklar ro'yxati"),
            BotCommand("pickrandom", "Tasodifiy izohchini tanlash"),
            BotCommand("trackpost", "Postni kuzatish (randomizer)"),
            BotCommand("mygiveaways", "Mening o'yinlarim"),
            BotCommand("mychannels", "Mening kanallarim (boshqarish)"),
            BotCommand("edit", "O'yinni tahrirlash"),
            BotCommand("notify", "Ishtirokchilarga xabar yuborish"),
            BotCommand("cancelgiveaway", "Yutuqli o'yinni bekor qilish"),
            BotCommand("cancelgroupgiveaway", "Guruh o'yinini bekor qilish"),
            BotCommand("mycontests", "Mening konkurslarim"),
            BotCommand("startvoting", "Ovoz berishni boshlash"),
            BotCommand("endcontest", "Konkursni yakunlash"),
            BotCommand("cancelcontest", "Konkursni bekor qilish"),
            ...
            BotCommand("subscribe", "Bildirishnomalarga obuna"),
            BotCommand("unsubscribe", "Obunani bekor qilish"),
            BotCommand("settings", "Sozlamalar"),
            BotCommand("dashboard", "Mini App ochish"),
